...
async function main() {
  console.log("🚀 Setting up DEMLE Real-time Monitoring...");
  ...
  // Create a simple HTML dashboard that polls the contract
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  // Write the HTML file
  writeFileSync('./realtime-dashboard.html', html);

  console.log(`
✅ Real-time Dashboard Generated!

📁 File: realtime-dashboard.html
🌐 Open this file in your browser to see live updates
...
📊 Shows miners, balances, and recent mining events in real-time
  `);

  // Keep the script running to maintain the local hardhat network
